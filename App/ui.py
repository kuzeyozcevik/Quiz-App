...
class QuizInterface:
    ...
    def __init__(self,quiz_brain : QuizBrain):
        ...
        self.true_button = tkinter.Button(image=image_true,highlightthickness=0,command=self.true_pressed)
        self.true_button.grid(row=2,column=0)
        image_false = PhotoImage(file="images/false.png")
        self.false_button = tkinter.Button(image=image_false,highlightthickness=0,command=self.false_pressed)
